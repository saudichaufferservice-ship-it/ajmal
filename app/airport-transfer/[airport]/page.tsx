    ...
    <>
      ...
      <section id="book" className="relative -mt-12 z-20 pb-24">
         <div className="max-w-5xl mx-auto px-0 md:px-4">
            <div className="bg-white rounded-none md:rounded-[3rem] shadow-[0_50px_100px_rgba(0,0,0,0.15)] p-5 md:p-14 border-y md:border border-slate-100 overflow-hidden relative">
